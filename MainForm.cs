...
namespace RiotAccountManager
{
    ...
    public class AccountManager
    {
        ...
        public static void AddAccount(string name, string username, string password, bool autoLogin, bool staySignedIn)
        {
    ...
    public class RiotAutoFill
    {
        ...
        public static async Task<bool> LoginWithAccount(Account account)
        {
    ...
    public partial class MainForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            accountGridView.Columns[0].Width = 150;
            accountGridView.Columns[1].Width = 147;
            ...
            accountGridView.SelectionChanged += AccountGridView_SelectionChanged;
            ...
            chkAutoLogin.CheckedChanged += CheckBox_CheckedChanged;
            ...
            chkStaySignedIn.CheckedChanged += CheckBox_CheckedChanged;
        ...
        private void AccountGridView_SelectionChanged(object sender, EventArgs e)
        {
            ...
            chkAutoLogin.Checked = selectedAccount.AutoLogin;
            chkStaySignedIn.Checked = selectedAccount.StaySignedIn;
            chkAutoLogin.Enabled = true;
            chkStaySignedIn.Enabled = true;
        ...
        {
            if (accountGridView.SelectedRows.Count == 0) return;
            ...
            var selectedAccount = accounts[selectedIndex];
            selectedAccount.AutoLogin = chkAutoLogin.Checked;
            selectedAccount.StaySignedIn = chkStaySignedIn.Checked;
        ...
        private async void BtnLogin_Click(object sender, EventArgs e)
        {
            ...
            bool success = await RiotAutoFill.LoginWithAccount(selectedAccount);

            if (success)
            {
                string message = selectedAccount.AutoLogin
    ...
    public class AddAccountForm : Form
    {
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                // Add mode
                AccountManager.AddAccount(txtName.Text, txtUsername.Text,
                    txtPassword.Text, false, false);
            }
